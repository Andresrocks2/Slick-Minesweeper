...
public class SlickMinesweeper extends StateBasedGame {
   ...
   public static final String gameName = "Minesweeper";
   ...
   public SlickMinesweeper(String gameName) {
   ...
   public static void main(String[] args) throws SlickException {
       ...
       try {
           appgc = new AppGameContainer(new SlickMinesweeper(gameName));
           ...
           appgc.setDisplayMode(800, 496, false);
